...
export default function PageView() {
  ...
  const [editCard, setEditCard] = useState(null) // null = new, obj = editing
        ...
        {cards.map((c) => (
          <div key={c.id} className="metric-card">
            <div className="card-header">
              ...
              {c.card_type && (
                <span className="card-type-badge">{c.card_type}</span>
              )}
            </div>
...
/* card form modal - kept in same file for simplicity */
